...
一个面向手机的「占卜合集」网页应用，一个文件（`dist/index.html`）就能打开，包含 17 个玩法（含「姻缘 · 事业 · 财富」人生三问），5 套可切换皮肤，支持手机体感操作：

| 玩法 | 怎么玩 | 内容 |
| --- | --- | --- |
| 姻缘 | 填生辰看正缘；两人生辰「牵红线」合婚 | 夫妻宫另一半模样、配偶星、红鸾天喜感情流年、桃花位、今日桃花；合婚分数（生肖 / 夫妻宫 / 日主 / 五行互补）与相处之道 |
| 事业 | 摇一摇落印求签；填生辰看格局 | 今日贵人方位、面谈吉时、事业指数、24 支事业签；六种事业格局、贵人属相、驿马、文昌、事业流年 |
| 财运 | 摇一摇摇钱树；填生辰看财库 | 今日财神方位、求财吉时、财运指数、宜忌、24 支财运签；七种财运类型、财星、财库、禄神、财运流年 |
...
「姻缘 · 事业 · 财富」三个玩法的实物目前只放了**最省资源的占位**（一枚字 + 名称），等外部 3D 模型接入：`yinyuan.knot`（同心结）、`yinyuan.thread`（红线）、`shiye.seal`（官印）、`shiye.ladder`（青云梯）、`caiyun.tree`（摇钱树）、`caiyun.vault`（财库）。建模方按上面的方式注册即可，模块代码不需改动。
