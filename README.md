...
> 筊杯 · 灵签 · 六爻 · 黄历 · 八字 · 风水 · 转盘 · 塔罗 · 卢恩 · 星座/生肖 · 水晶球/灵摆 · 御神签 · 硬币骰子 · 落球盘
...
一个面向手机的「占卜合集」网页应用，一个文件（`dist/index.html`）就能打开，包含 14 个玩法，5 套可切换皮肤，支持手机体感操作：
...
| 落球盘 | 点击放球 | 2–6 个可编辑槽位，重力碰撞与连续弹跳，约 9–10 秒后落定揭晓 |
...
风水罗盘、星仪、水晶球、灵摆和四柱命牌已内置三维绘制，随玩法状态、拖动和体感变化。模型由代码生成，统一管理尺寸、皮肤与动画清理。
